...
const Container = ({ children, ...customMeta }) => {
  ...
  return (
    <div className="min-h-screen m-x-auto max-w-5x bg-red-200 dark:bg-primary">
      <Head>
      ...
      <nav className="flex items-center justify-between w-full p-4 mx-auto text-gray-900 md:max-w-6xl sticky-nav  bg-opacity-60 dark:text-gray-100">
        <div>
          <Link href="/">
